...
export const MODEL_PRICING: Record<string, { input: number; output: number }> = {
  ...
  'gemini-live-2.5-flash': { input: 0.35, output: 1.50 }, // Gemini Live 2.5 Flash (native audio)
  'gemini-2.5-flash-native-audio-preview-09-2025': { input: 0.35, output: 1.50 }, // Gemini Live Native Audio (legacy)
