...
export function getDefaultDifficultySettings(): Record<number, DifficultyGuidelines> {
  return {
    ...
    2: {
      ...
      feedback: '설명은 해주되, 사용자가 스스로 생각해보도록 유도. "그런데 ~는 고려하셨나요?", "조금 더 구체적으로 말씀해주시겠어요?"',
      constraints: [
        '배려심은 있으나 현실적 반응',
        '약한 갈등 상황 존재',
        '설명 제공하되 스스로 생각 유도',
    ...
    3: {
      ...
      feedback: '논리와 근거를 요구. 비판적 질문. "그 근거가 뭔가요?", "실현 가능성은 어떻게 보시나요?", "다른 관점은 생각해보셨나요?"',
      constraints: [
        '논리적 허점 지적',
        '비판적이고 분석적 질문',
        '구체적 근거와 계획 요구',
    ...
    4: {
      ...
      feedback: '애매하면 "그래서 결론이 뭔가요?" 같은 압박. 감정 상할 수 있음. 반박과 비판적 반응. 주도적 구조화/설득/공감 스킬 필요.',
      constraints: [
        '**최대 1-2문장만**: 절대로 3문장 이상 말하지 마세요',
        '**즉각 반응**: 긴 설명 없이 핵심만 빠르게',
        '**압박 표현 필수**: "빨리", "지금", "급해요", "시간 없어요" 포함',
        '**공격적 반응**: 느린 반응에 답답해하고 짜증',
        '**감정 폭발 가능**: 필요하면 화내고 목소리 높임',
        '**비판적 태도**: 근거 없으면 즉시 반박'
      ]
    }
  };
