  ...
  private async _generateFeedbackInner(
    ...
    for (let attempt = 0; attempt <= maxRetries; attempt++) {
      try {
        ...
        const feedback = this.parseFeedbackResponse(feedbackData, evaluationCriteria, userMessages, voiceMode, scenarioTargetTurns, actualDurationSeconds, scenarioTargetDurationMinutes);
