        ...
        <ScrollArea className="h-[calc(100vh-120px)]">
          <div className="bg-slate-50 rounded-2xl p-8 text-slate-800 border border-slate-200">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제1조 (수집하는 개인정보 항목)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제2조 (개인정보의 수집 및 이용 목적)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제3조 (개인정보의 보유 및 이용 기간)</h2>
              <ul className="list-disc list-inside space-y-2 text-slate-700 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제4조 (개인정보의 제3자 제공)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제5조 (개인정보 처리 위탁)</h2>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-200">
                      <th className="text-left py-2 text-slate-900 font-semibold">수탁업체</th>
                      <th className="text-left py-2 text-slate-900 font-semibold">위탁 업무</th>
                    </tr>
                  </thead>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제6조 (이용자의 권리와 행사 방법)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제7조 (개인정보의 안전성 확보 조치)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제8조 (개인정보 보호책임자)</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-slate-900">제9조 (개인정보처리방침의 변경)</h2>
              <p className="text-slate-700">
