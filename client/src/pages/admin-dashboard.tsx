...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Extended Metrics - 시간 기반 분석 */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="card-enhanced" data-testid="card-dau">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">DAU (일간)</CardTitle>
            <i className="fas fa-calendar-day text-purple-600"></i>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold" data-testid="dau-value">{overview?.dau || 0}명</div>
            <p className="text-xs text-slate-600">오늘 활동한 사용자</p>
          </CardContent>
        </Card>

        <Card className="card-enhanced" data-testid="card-wau">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">WAU (주간)</CardTitle>
            <i className="fas fa-calendar-week text-indigo-600"></i>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold" data-testid="wau-value">{overview?.wau || 0}명</div>
            <p className="text-xs text-slate-600">이번 주 활동한 사용자</p>
          </CardContent>
        </Card>

        <Card className="card-enhanced" data-testid="card-mau">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">MAU (월간)</CardTitle>
            <i className="fas fa-calendar-alt text-teal-600"></i>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold" data-testid="mau-value">{overview?.mau || 0}명</div>
            <p className="text-xs text-slate-600">이번 달 활동한 사용자</p>
          </CardContent>
        </Card>
